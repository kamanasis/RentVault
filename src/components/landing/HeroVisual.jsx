...
export const HeroVisual = () => {
  ...
  return (
    <div className="relative w-full max-w-xl mx-auto aspect-square flex flex-col items-center justify-center p-3 sm:p-5 select-none perspective-[1400px]">
      
      {/* ─── ROLE SIMULATION SEGMENTED TOGGLE (Top Center) ─── */}
      <div className="absolute top-0 z-30 flex items-center gap-1.5 p-1 rounded-2xl bg-card/90 backdrop-blur-xl border border-primary/30 shadow-xl">
        <button
          type="button"
      ...
      <div className="relative w-full h-full flex items-center justify-center pt-8 pb-4">
        ...
        {/* ─── 3D ATOMIC PHOTON ORBITAL RINGS (Luminous Beams • Zero Text Overlap!) ─── */}
        
        {/* ⚛️ Alpha Orbital: Cyan Photon (+65deg Pitch, +24deg Yaw) */}
        <div 
        ...
        {/* ⚛️ Beta Orbital: Purple Photon (-65deg Pitch, +24deg Yaw) */}
        <div 
          className="absolute w-[88%] h-[88%] pointer-events-none flex items-center justify-center z-0"
          style={{ transform: 'rotateX(-65deg) rotateY(24deg)', transformStyle: 'preserve-3d' }}
        >
        ...
        {/* ⚛️ Gamma Orbital: Indigo Photon (+82deg Equator Orbit) */}
        <div 
        ...
        {/* ─── 👮‍♀️ IMMACULATE OFFICER EVA (The Android Escrow Commander - Nucleus) ─── */}
        <motion.div
          animate={{ 
            y: [-8, 8, -8],
        ...
        >
          ...
          {/* 🌟 Glossy Pearlescent Egg Head with Seamlessly Integrated Officer Crest */}
          <motion.div
          ...
          >
            ...
            {/* 👮 INTEGRATED OFFICER HEADBAND & GOLD STELLAR STAR CREST */}
            ...
            {/* Deep Obsidian Black Curved Glass Visor Faceplate */}
            <div className="relative w-28 h-18 rounded-[50%/60%_60%_40%_40%] bg-gradient-to-b from-slate-950 via-black to-slate-950 border border-slate-700/60 shadow-inner flex items-center justify-center overflow-hidden p-2 mt-1">
              ...
              {/* 💙 Glowing Cyan LED Expressive Eyes (Smoothly tracking cursor!) */}
              <motion.div 
                style={{
                  x: headPose.eyeX,
                  y: headPose.eyeY,
              ...
              >
                ...
                {robotMood === 'blink' ? (
                  ...
                  /* Normal Expressive Cyan Slanted Oval */
          ...
          <div className="relative mt-2 flex items-center justify-center" style={{ transformStyle: 'preserve-3d' }}>
            ...
            {/* Central Pearlescent Capsule Body */}
            <motion.div
            ...
            >
              {/* Officer Collar & Amber Tie Accent */}
              ...
              {/* Glowing Stellar Security Shield Badge */}
        ...
        {/* ─── 4 CORNER FLOATING TELEMETRY CHIPS (Spacious & Ergonomic Layout) ─── */}

        {/* Chip 1: Real-Time Escrow Balance Telemetry (Top-Left) */}
        <motion.div 
          ...
          className={`absolute top-2 left-0 sm:-left-3 z-20 bg-card/95 backdrop-blur-xl border px-3.5 py-2.5 rounded-2xl shadow-xl flex flex-col gap-1 max-w-[220px] cursor-pointer transition-all duration-300 ${
        ...
        >
          ...
          {/* Interactive Expanded Detail Breakdown */}
          {expandedChip === 'balance' && (
            ...
            >
              ...
              <div className="flex justify-between text-cyan-400 font-bold pt-1 border-t border-border/40">
                <span>Contract Custody:</span>
        ...
        {/* Chip 2: Speed & Finality Meter (Top-Right) */}
        <motion.div 
          initial={{ opacity: 0, y: 16 }}
          animate={{ opacity: 1, y: 0 }}
          ...
          className={`absolute top-4 right-0 sm:-right-3 z-20 bg-card/95 backdrop-blur-xl border px-3 py-2 rounded-2xl shadow-xl flex flex-col gap-1 max-w-[200px] cursor-pointer transition-all duration-300 ${
        ...
        {/* Chip 3: Soroban Protocol 20 (Bottom-Left) */}
        <motion.div 
          initial={{ opacity: 0, y: 16 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.3 }}
          whileHover={{ scale: 1.04 }}
          className="absolute bottom-2 left-0 sm:left-0 z-20 bg-card/95 backdrop-blur-xl border border-cyan-400/40 px-3.5 py-2.5 rounded-2xl shadow-xl flex items-center gap-2.5"
        >
        ...
        {/* Chip 4: Wallet Authentication Status (Bottom-Right) */}
        <motion.div 
          initial={{ opacity: 0, y: 16 }}
          animate={{ opacity: 1, y: 0 }}
          ...
          className={`absolute bottom-2 right-0 sm:right-0 z-20 bg-card/95 backdrop-blur-xl border px-3.5 py-2.5 rounded-2xl shadow-xl flex flex-col gap-1 cursor-pointer transition-all duration-300 ${
